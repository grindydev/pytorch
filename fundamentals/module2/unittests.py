...
def exercise_1(learner_func, data_path):
    def g():
        cases = []
        ...
        try:
            dataloader_battery = DataLoaderBattery(learner_func, data_path)
...
def exercise_4(learner_func, learner_model, learner_test_loader, data_path):
    def g():
        cases = []
        ...
        try:
            evaluate_battery = EvaluateBattery(
                learner_func, model=learner_model, data_loader=learner_test_loader, data_path=data_path
            )
