...
def exercise_1(learner_class, local_path):
    def g():
        cases = []
        ...
        tokenizer = unittests_utils.load_tokenizer(local_path)
        try:
...
def exercise_2(learner_func, local_path):
    def g():
        cases = []
        ...
        tokenizer = unittests_utils.load_tokenizer(local_path=local_path)
        try:
...
def exercise_3(learner_func, local_path):
    def g():
...
def exercise_5(learner_func, local_path):
    def g():
        cases = []
        ...
        original_model = unittests_utils.load_bert_model(local_path=local_path, num_classes=num_classes)
