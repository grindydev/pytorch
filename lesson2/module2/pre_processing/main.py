...
ox3_pet_data_path = Path.cwd() / 'data/oxford3pet_data'
fruits_data_path = Path.cwd() / 'data/fruit_images'
...
# Load an image
image = Image.open(fruits_data_path / 'mangoes.jpg')
...
image_path = fruits_data_path / 'apples.jpg'
...
images_tensor = helper_utils.load_images(fruits_data_path)
...
original_image = Image.open(fruits_data_path / 'strawberries.jpg')
