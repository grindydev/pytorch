...
def exercise_4(learner_func, data_module, classifier,data_dir, model_weights_path):
    def g():
        cases = []
        ...
        try:
            ...
            dummy_dm = data_module(data_dir=data_dir, batch_size=2)
            dummy_model = classifier(model_weights_path=model_weights_path)
