...
def get_data_loaders_with_validation(batch_size, val_fraction=0.1):
    ...
    full_trainset = datasets.CIFAR10(root= Path.cwd()/'data/rich_cifar10', train=True, download=True, transform=transform_train)
    ...
    test_set = datasets.CIFAR10(root= Path.cwd()/'data/rich_cifar10', train=False, download=True, transform=transform_test)
