...
def get_dataset_dataloaders(batch_size=64, subset_size=10_000, imbalanced=False, data_path="./cifar10", data_path_imbalanced="./cifar10_3class_imbalanced" ):
    ...
    if imbalanced:
        ...
        full_trainset = ImageFolder(
            root=data_path_imbalanced, transform=transform
        )
