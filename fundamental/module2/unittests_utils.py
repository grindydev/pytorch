...
class TestBattery:
    def __init__(self, learner_object, data_path):
...
class DataLoaderBattery(TestBattery):
    def _get_reference_inputs(self):
        self.train_dataset, self.test_dataset = get_train_test(self.data_path)
        self.batch_size = 32
...
class TrainBattery(TestBattery):
    def __init__(self, learner_object, model, loss_function, optimizer, train_loader, data_path):
        self.model = model
        self.loss_function = loss_function
        self.optimizer = optimizer
        self.train_loader = train_loader

        super().__init__(learner_object, data_path)
...
class EvaluateBattery(TestBattery):
    def __init__(self, learner_object, model, data_loader, data_path):
        self.model = model
