...
import tarfile
import requests
from flower_dataset import Denormalize
...
def visualize_augmentations(dataset_aug, denormalize, idx=0, num_versions=8):
    """
    ...
    # denormalize = Denormalize(mean, std, transforms=dataset_aug.transform)
    ...
    fig, axes = get_grid(n_rows, n_cols, figsize=(16, 8))
